...
public abstract class DefamedCrystalOutgrowthItem extends ArmorItem {
	public DefamedCrystalOutgrowthItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public String getName() {
				return "defamed_crystal_outgrowth";
			}
	...
	public static class Helmet extends DefamedCrystalOutgrowthItem {
		public Helmet() {
			...
			consumer.accept(new IClientItemExtensions() {
				...
				public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("head", new Modeldefamed_crystal_outgrowth(Minecraft.getInstance().getEntityModels().bakeLayer(Modeldefamed_crystal_outgrowth.LAYER_LOCATION)).bone, "hat",
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "vortex:textures/models/armor/defamed_crystal_outgrowth__layer_1.png";
		}
