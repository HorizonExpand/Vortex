...
public class OilRollBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(1, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public OilRollBlockEntity(BlockPos position, BlockState state) {
		super(VortexModBlockEntities.OIL_ROLL.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("oil_roll");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Oil Roll");
	}
