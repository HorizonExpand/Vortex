		...
		if (entity instanceof Player _player)
			_player.getFoodData()
					.setSaturation((float) ((entity instanceof Player _plr ? _plr.getFoodData().getSaturationLevel() : 0)
							+ ((ForgeRegistries.ITEMS.getValue(new ResourceLocation(((itemstack.getOrCreateTag().getString("0"))).toLowerCase(java.util.Locale.ENGLISH))).isEdible()
									? ForgeRegistries.ITEMS.getValue(new ResourceLocation(((itemstack.getOrCreateTag().getString("0"))).toLowerCase(java.util.Locale.ENGLISH))).getFoodProperties().getSaturationModifier()
									: 0)
									+ (ForgeRegistries.ITEMS.getValue(new ResourceLocation(((itemstack.getOrCreateTag().getString("1"))).toLowerCase(java.util.Locale.ENGLISH))).isEdible()
											? ForgeRegistries.ITEMS.getValue(new ResourceLocation(((itemstack.getOrCreateTag().getString("1"))).toLowerCase(java.util.Locale.ENGLISH))).getFoodProperties().getSaturationModifier()
											: 0)
									+ (ForgeRegistries.ITEMS.getValue(new ResourceLocation(((itemstack.getOrCreateTag().getString("2"))).toLowerCase(java.util.Locale.ENGLISH))).isEdible()
											? ForgeRegistries.ITEMS.getValue(new ResourceLocation(((itemstack.getOrCreateTag().getString("2"))).toLowerCase(java.util.Locale.ENGLISH))).getFoodProperties().getSaturationModifier()
											: 0)
									+ (ForgeRegistries.ITEMS.getValue(new ResourceLocation(((itemstack.getOrCreateTag().getString("3"))).toLowerCase(java.util.Locale.ENGLISH))).isEdible()
											? ForgeRegistries.ITEMS.getValue(new ResourceLocation(((itemstack.getOrCreateTag().getString("3"))).toLowerCase(java.util.Locale.ENGLISH))).getFoodProperties().getSaturationModifier()
											: 0)
									+ (ForgeRegistries.ITEMS.getValue(new ResourceLocation(((itemstack.getOrCreateTag().getString("4"))).toLowerCase(java.util.Locale.ENGLISH))).isEdible()
											? ForgeRegistries.ITEMS.getValue(new ResourceLocation(((itemstack.getOrCreateTag().getString("4"))).toLowerCase(java.util.Locale.ENGLISH))).getFoodProperties().getSaturationModifier()
											: 0)
									+ (ForgeRegistries.ITEMS.getValue(new ResourceLocation(((itemstack.getOrCreateTag().getString("5"))).toLowerCase(java.util.Locale.ENGLISH))).isEdible()
											? ForgeRegistries.ITEMS.getValue(new ResourceLocation(((itemstack.getOrCreateTag().getString("5"))).toLowerCase(java.util.Locale.ENGLISH))).getFoodProperties().getSaturationModifier()
											: 0))
									* 1.5));
	}
}
