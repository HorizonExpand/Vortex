...
public class PreservesJarGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PreservesJarGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(VortexModMenus.PRESERVES_JAR_GUI.get(), id);
		...
		this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 124, 53) {
